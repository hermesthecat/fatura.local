...
try {
    ...
    if (!isset($_SESSION['company_id'])) {
        throw new Exception("Lütfen önce bir şirket seçin!");
    }
    ...
    if (!$kalemler) {
        throw new Exception("Fatura kalemleri bulunamadı!");
    }
    ...
    if ($fatura['para_birimi_kod'] == 'TRY') {
        // YAZI İLE kısmı
        $yazi_ile = 'YAZI İLE: ' . sayiyiYaziyaCevir($fatura['genel_toplam']);
