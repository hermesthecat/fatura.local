                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <?php echo number_format($kalem['birim_fiyat'], 2, ',', '.'); ?> <?php echo PARA_BIRIMI; ?>
                                    </td>
                                    <td class="text-end">
                                        <?php echo number_format($kalem['toplam_fiyat'], 2, ',', '.'); ?> <?php echo PARA_BIRIMI; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
