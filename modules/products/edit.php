...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validasyon
    $errors = $product->validate($data, $id);
    ...
    // Form verilerini ürün bilgileriyle doldur
    $_POST = $productData;
}
        ...
        <form method="post" action="" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="durum" name="durum">
                    <option value="aktif" <?= ($_POST['durum'] ?? '') === 'aktif' ? 'selected' : '' ?>>Aktif</option>
